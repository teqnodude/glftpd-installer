...
namespace eval ::ngBot::plugin::TVMaze {
	...
	set tvmaze(proxyuser) ""
	set tvmaze(proxypass) ""
	##
	set tvmaze(sections) { "/site/TV-HD/" "/site/TV-NL/" "/site/TV-SD/" }
	##
		...
		foreach path $tvmaze(sections) {
			if {[string match -nocase "$path*" $release]} {
				...
				if {($empty == 0) || ([string is true -strict $tvmaze(announce-empty)])} {
						...
						#PRIVMSG "$chan :arg1: $arg1 - arg2: $arg2 - arg3: $arg3 - arg4: $arg4 - arg5: $arg5 - arg11: $arg11 - arg12: $arg12 - arg13: $arg13"
						#PRIVMSG "$chan :arg14: $arg14 - arg15: $arg15 - arg16: $arg16 - arg17: $arg17 - arg19: $arg19 - arg20: $arg20 - arg21: $arg21 - arg22: $arg22"
						#PRIVMSG "$chan :arg23: $arg23 - arg24: $arg24 - arg25: $arg25 - arg26: $arg26 - arg27: $arg27"
